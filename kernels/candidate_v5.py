STIgXfhUN!3+XCeg7L>R74#yRGJbIb$#hJo*;&>YU;xr$gvR`u|q>KDB-4f~D5a}`JDBbGQP<9>JMJgQ<F&TU5ZXQKKu6+fVkB~iz+$sOFSOF&+DcwQl@lTpXgmqecSG*8`?MDwn0El<|1<p@vvuU~%o=P%wFAAeo97Oq=I^O(r9SM0+ECjJB_{sboe1Sb9j>Wl+*#-sb_v0zf(idhMx`}U*z?|}()=x%IHbFZ;JLmZ&l6Svdv$K<-A$#vKd57i~0PIa`t0Co3?y8B!)F%7e<I%ZjIbO|4=z5wf1#4GcY&-=l;bv??r#u2`CXWhD-qi^lgIXvd>x)qa?m;6+>K3IPa)_<bAcvH9Tu6OG>eB?)4w<2#E(~b1sZ=?Qf$X_S&*NOafB7dEAz775pb?}LOuEai9VkXsSeQV--aJVkEqQ44#rX90eIh|piv2LACt6Td6y4dnG;o9C!jvg*tuWrcVjO*}DIx@VNkMi<6=~xk_I{Zg>#4#}e6Cv89&ZW_vbYwvBx^HHFe6*c(WfrkQtJ7^bm(m!m@tyS1lm8N##XffOAI=8qq4`-@5zhUCGmG;>7233ap86@)`Fd>;?OdSEN)hHcQA)cDCM?h}@Gwwv8W?mL7<4&2g6YLaDb2SLaEc$Ct*eCv3oW%up`>9rWj8vgbaW&V22UnhtP(9&8_Ue@LTefu=RZ6W3D3)-t>0r7@mCk$@AY?o{qfhIF6)&)zW2phyR)tQ^C<rKUzfV$OD%E9SC{+V?f1=JzW(96Zy(<9+Bb7`le{}j^m_5tnVjB9)?F{YdTit1;{KeS`*U{AM|YkME{;bQKYkZn)yda{Sv_>=>a`B+;Nt7+UJjkW`kd>24;z%DTQAQ!?)4eReJyi1eBAS+$2}eVq2u7<_3`6=;EsKD_xo?Je)~V>6CrQ')))
# V5: receding-horizon livestock planner. Standard library inference only.
# It observes public farms and markets; private opponent inventory and game
# randomness are neither available nor used. Forecasts are estimates.
_PLAN_PARENT = agent
del agent
_V4_BRANCH = choose_branch
_BASE_PROGRAMS = _ROUTES
_PLAN_MEMORY = {}
_PLANNER_LOG = []
_KINDS = ('COW', 'SHEEP', 'GOOSE')
_GOODS = ('MILK', 'WOOL', 'EGG')
_FIRST = (8, 6, 4)
_INTERVAL = (2, 3, 1)
_HELD = (6, 6, 4)
_COST = (400, 500, 300)
# Planner parameters: supply, care, future-herd growth, future demand,
# opponent-relative objective, downside weight, and incumbent inertia.
PLAN_WEIGHTS = [1.0, 0.90, 0.70, 1.0, 1.0, 0.20, 0.0]
FORCE_EARLY = -1
FORCE_LATE = -1
PLAN_EARLY = True
PLAN_LATE = True
...
def choose_branch(obs):
    # All Fih bundles now use route zero's geometry. The planner edits its
    # purchases, pickups, structures and placements as a single transaction.
    return 0

def _observe_rival(obs, memory):
    ...
    for y, row in enumerate(farm['tiles']):
        for x, tile in enumerate(row):
            if not isinstance(tile, dict) or tile.get('animal') not in _KINDS:
                continue
            k = _KINDS.index(tile['animal'])
            counts[k] += 1
            tiles[x, y] = (k, tile['placed_day'], tile.get('yield_units', 0))
    if step % 24 == 23:
        for y, row in enumerate(farm['tiles']):
            for x, tile in enumerate(row):
                if (x, y) in tiles:
                    k = tiles[x, y][0]
                    memory['care_n'][k] += 1
                    memory['care_y'][k] += int(tile.get('cared_today', False) and tile.get('fed_today', False))
        memory['counts'].append([step // 24, counts])

def _own_supply(obs, route, early, late):
    """Replay only animal care/production/collection to the actual final turn."""
    data = _PROGRAM_DATA[str(route)]
    step = int(obs['step'])
    farm = _farm(obs, _seat(obs))
    supply = [[0.0] * 30 for _ in range(3)]
    kinds = [_KINDS.index(slot['animal']) for slot in data['slots']]
    for group, choice in enumerate((early, late)):
        for i in data['groups'][group]:
            # Option 3 is Fih's first three sheep and last cow.
            kinds[i] = (0 if i == data['groups'][1][-1] else 1) if choice == 3 else choice
    for i, slot in enumerate(data['slots']):
        x, y = slot['pos']
        tile = farm['tiles'][y][x]
        future = slot['place'] >= step
        if future:
            kind, day, begin = kinds[i], slot['place'] // 24, slot['place']
            held, bonus, unfed, fed, cared = 0, 0, 0, False, False
        elif isinstance(tile, dict) and tile.get('animal') in _KINDS:
            kind = _KINDS.index(tile['animal'])
            day, begin = tile['placed_day'], step
            held, bonus = tile.get('yield_units', 0), tile.get('pending_care_bonus', 0)
            unfed, fed, cared = tile.get('consecutive_unfed', 0), tile.get('fed_today', False), tile.get('cared_today', False)
        else:
            continue
        events = slot['events']
        j = 0
        while j < len(events) and events[j][0] < begin:
            j += 1
        for d in range(begin // 24, 30):
            while j < len(events) and events[j][0] < (d + 1) * 24:
                t, op = events[j]
                j += 1
                if op == 0:
                    fed = True
                    ...
                    # The complete worker route delivers the collection.
                    supply[kind][d] += held
                    held = 0
            if d == 29:
                break
            unfed = 0 if fed else unfed + 1
            if unfed >= 2:
                break
            age = d + 1 - day - _FIRST[kind]
            if age >= 0 and age % _INTERVAL[kind] == 0:
                held = min(_HELD[kind], held + 1 + (bonus if fed else 0))
                bonus = 0
            if fed and cared:
                bonus += 1
            fed = cared = False
    private = obs['private']
    for k, p in enumerate(_GOODS):
        supply[k][step // 24] += private['shed'].get(p, 0)
        supply[k][step // 24] += sum(b.get(p, 0) for b in private['inventories'])
    return supply

def _rival_supply(obs, memory, weights):
    step = int(obs['step'])
    start = step // 24
    farm = _farm(obs, 1 - _seat(obs))
    supply = [[0.0] * 30 for _ in range(3)]
    counts = [0, 0, 0]
    care = [(weights[1] * 6 + memory['care_y'][k]) / (6 + memory['care_n'][k]) for k in range(3)]
    for row in farm['tiles']:
        for tile in row:
            ...
            k = _KINDS.index(tile['animal'])
            counts[k] += 1
            bonus = float(tile.get('pending_care_bonus', 0))
            supply[k][start] += tile.get('yield_units', 0)
            for d in range(start, 29):
                age = d + 1 - tile['placed_day'] - _FIRST[k]
                if age >= 0 and age % _INTERVAL[k] == 0:
                    supply[k][d + 1] += min(_HELD[k], 1 + bonus)
                    bonus = 0
                bonus += care[k]
    # Forecast unobserved expansion, with a bounded prior rather than assuming
    # the rival stops buying animals at this observation.
    old = next((c for d, c in reversed(memory['counts']) if d <= start - 3), [0, 0, 0])
    additions = [max(0, counts[k] - old[k]) for k in range(3)]
    missing = max(0, 17 - sum(counts)) * max(0, min(1.0, (12 - start) / 6)) * weights[2]
    blend = [1 + counts[k] * 0.15 + additions[k] for k in range(3)]
    norm = sum(blend)
    for k in range(3):
        n = missing * blend[k] / norm
        for delay in (1, 3):
            birth = start + delay
            bonus = 0.0
            for d in range(birth, 29):
                age = d + 1 - birth - _FIRST[k]
                if age >= 0 and age % _INTERVAL[k] == 0:
                    supply[k][d + 1] += n * 0.5 * min(_HELD[k], 1 + bonus)
                    bonus = 0.0
                bonus += care[k]
    return [[q * weights[0] for q in row] for row in supply]

def _model_price(kind, inventory):
    # Same response curves as the supplied engine, without integer rounding.
    x = inventory - 10000.0
    if kind == 0:
        return max(1.0, 160 - 256 * x / 122) if x >= 0 else 160 + 96 * math.sqrt(-x / 122)
    if kind == 1:
        return max(1.0, 200 - 640 * (x / 105) ** 2) if x >= 0 else 200 + 40 * math.log1p(-x) / math.log(106)
    if x >= 0:
        return max(1.0, 50 - 10 * math.log1p(x) / math.log(333))
    u = -x / 332
    return 50 + 20 * (u + 8 * max(0, u - 1) ** 2)

def _forecast_score(obs, own, rival, cost, weights):
    shops = obs['town']['unlocked_shops']
    daily = [6 * sum(shops.count(s) for s in ('PIZZA_SHOP', 'ICE_CREAM_SHOP', 'SMOOTHIE_SHOP')) + 1,
             12 * shops.count('YARN_STORE') + 1,
             6 * sum(shops.count(s) for s in ('BAKERY', 'BRUNCH_SPOT')) + 1]
    start = int(obs['step']) // 24
    values = []
    # Mean and two adverse compositions for still-unrevealed shops. These are
    # scenarios, not predictions of the game's hidden random draws.
    for scenario in ((1.0, 1.0, 1.0), (0.5, 1.75, 1.0), (1.5, 0.25, 1.0)):
        value = -cost
        inventory = [float(obs['market']['inventory'][p]) for p in _GOODS]
        for d in range(start, 30):
            future = max(0, min(8, d // 3) - len(shops))
            for k in range(3):
                demand = daily[k] + future * (2.25, 1.5, 1.5)[k] * scenario[k] * weights[3]
                q, r = own[k][d], rival[k][d]
                # Daily clearing approximation, corrected at the next decision
                # by actual public prices, herds and revealed town shops.
                mid = inventory[k] + 0.5 * (q + r - demand)
                price = _model_price(k, mid)
                value += (q - weights[4] * r) * price
                inventory[k] += q + r - demand
        values.append(value)
    return (1 - weights[5]) * sum(values) / 3 + weights[5] * min(values)

def _bundle_cost(route, early, late):
    groups = _PROGRAM_DATA[str(route)]['groups']
    return len(groups[0]) * _COST[early] + (3 * 500 + 400 if late == 3 else len(groups[1]) * _COST[late])

def _edit_bundle(memory, route, group, choice):
    tape = memory['routes'][route]
    data = _PROGRAM_DATA[str(route)]
    for t, u, kind in data['changes'][group]:
        if t not in memory['edited']:
            tape[t] = _copy_action(tape[t])
            memory['edited'].add(t)
        # Mixed Fih bundle: only the last animal is converted to a cow.
        target = (0 if (t >= 264 or kind == 0 and t == 254) else 1) if choice == 3 else choice
        op = tape[t]['market'][u] if kind == 2 else tape[t]['farmer'] if u == 0 else tape[t]['hands'][u - 1]
        if kind == 0:
            op[0] = 'BUILD_COOP' if target == 2 else 'BUILD_PASTURE'
        else:
            op[1] = _KINDS[target]

def _choose_plan(obs, memory, route, group):
    defaults = [1 if route == 0 else 0,
                {0: 1, 1: 0, 2: 3, 3: 2}[_V4_BRANCH(obs)] if route == 0 else 2]
    if group == 1:
        defaults[0] = memory['early']
    early_options = range(3) if group == 0 else [memory['early']]
    late_options = range(4 if route == 0 else 3)
    rival = _rival_supply(obs, memory, PLAN_WEIGHTS)
    scores = []
    supplies = []
    for e in early_options:
        for l in late_options:
            own = _own_supply(obs, route, e, l)
            cost = _bundle_cost(route, e, l)
            value = _forecast_score(obs, own, rival, cost, PLAN_WEIGHTS)
            value -= PLAN_WEIGHTS[6] * ((e != defaults[0]) + (l != defaults[1]))
            scores.append([value, e, l])
            if CAPTURE_PLANS:
                supplies.append(own)
    chosen = max(scores)
    e, l = chosen[1:]
    if group == 0:
        ...
        if FORCE_LATE >= 0:
            l = FORCE_LATE
        memory['late'] = l
        _edit_bundle(memory, route, 1, l)
    _PLANNER_LOG.append({'step': int(obs['step']), 'route': route, 'scores': scores,
                         'early': e, 'late': l, 'defaults': defaults})
    if CAPTURE_PLANS:
        snapshot = {k: copy.deepcopy(obs[k]) for k in ('step', 'player', 'town', 'market')}
        snapshot['farms'] = [{'tiles': [[copy.deepcopy(t) if isinstance(t, dict) and 'animal' in t else None
                                       for t in row] for row in f['tiles']]} for f in obs['farms']]
        _PLANNER_LOG[-1]['capture'] = {'obs': snapshot, 'own': supplies,
            'memory': {k: copy.deepcopy(memory[k]) for k in ('counts', 'care_n', 'care_y')}}

def agent(obs, configuration=None):
    global _ROUTES
    seat, step = _seat(obs), int(obs['step'])
    memory = _PLAN_MEMORY.get(seat)
    if memory is None or step <= memory['last']:
        memory = {'last': -1, 'routes': list(_BASE_PROGRAMS), 'edited': set(),
                  'counts': [], 'care_n': [0, 0, 0], 'care_y': [0, 0, 0]}
        _PLAN_MEMORY[seat] = memory
        _PLANNER_LOG.clear()
    memory['last'] = step
    _ROUTES = memory['routes']
    _observe_rival(obs, memory)
    route = 4 if LIVE_BRANCHES.get(seat, 0) == 4 else 0
    if step == 144:
        # Copy only the chosen programme, only when it first needs editing.
        memory['routes'][route] = list(_BASE_PROGRAMS[route])
        _choose_plan(obs, memory, route, 0)
    elif step == (240 if route == 0 else 216):
        _choose_plan(obs, memory, route, 1)
    action = _PLAN_PARENT(obs, configuration)
    if step < 144:
        return action
    bags = obs['private']['inventories']
    units = [action['farmer']] + action['hands']
    for i, op in enumerate(units):
        if i >= len(bags):
            break
        if op[0] == 'PLACE' and len(op) > 1 and op[1] in _GOODS and not bags[i].get(op[1], 0):
            other = next((p for p in _GOODS if bags[i].get(p, 0) > 0), None)
            if other:
                units[i] = ['PLACE', other, 10000]
    action['farmer'], action['hands'] = units[0], units[1:]
    if step < 718 and any(o[0] == 'SELL' and o[1] in _GOODS for o in action['market']):
        shed = _shed_projection(obs, action)
        for item in _GOODS:
            quantity = shed.get(item, 0)
            if quantity <= 0:
